...
const Hero = () => {
  ...
  return (
    ...
    <div className=" flex flex-row  h-full ">
      ...
      {/* left side    */}
      <div className="flex flex-col gap-10  w-[50%] pl-[77px]  mt-[120px]">
        {/* Tagline */}
        ...
        <div className="flex flex-row gap-10">
            <Button styles={' h-[56px] , w-[227px] , text-base '} children={"Book an Appointment"}/>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2  gap-8 place-items-center w-[25vw]">
            {/* Info 1 */}
      ...
      <div className=" flex flex-col justify-center items-center  w-[50%]">
        {/* Background Circle and Image */}
          <div className="absolute w-[396px] h-[402px] bg-ImgBack-gradient rounded-t-[300px]">
          </div>

          <div >
            <img src={HeroImg} alt=""  className=" relative   w-[482px] h-[476px] left-4 top-[123px]  " />
          </div>

        {/* Comment Section */}
       <div className=" relative w-[241px] h-[128px] bg-white border-2 border-[#95DDFF] rounded-xl shadow-md p-4  flex flex-col justify-between left-44 bottom-44 ">
          {/* Top: Images + Number */}
        ...
        {/* comment two */}
        <div className=" relative flex justify-center items-center gap-2 w-[296px] h-[44px] rounded-[10px] bg-white shadow-md bottom-44 right-40">
        ...
        {/* comment Three */}
              <span className=" relative bottom-28 text-Primary-Blue-500 text-6xl right-2 z-10  "><BsQuote/></span>
        <div className=" relative flex justify-center items-center gap-2 w-[300px] h-[88px] rounded-[10px] bg-white border-2 border-[#95DDFF] shadow-md left-28 bottom-36">
