...
const SpecialitiesCard = () => {
    return (
        ...
        <div className=' flex flex-col font-general-sans bg-Primary-Blue-50 p-6 gap-2 rounded-lg shadow-lg max-w-[420px]  2xl:max-w-[450px]'>
            ...
            <div className=' font-medium text-2xl'>Cardiology</div>
            <div className=' text-justify text-lg'>Heart health is at the core of overall wellness. Our cardiologists specialize in diagnosing and treating cardiovascular diseases.</div>
