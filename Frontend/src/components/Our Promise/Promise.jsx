  ...
  const promiseData = [
    {
      ...
      description:
        "We offer same-day appointments whenever possible and make it easy to reschedule if needed.",
    },
    {
      img: promise2,
      title: "Price Match",
      description:
        "If you receive a cheaper quote we will match it, so you can get the best value for yur care.",
    },
    {
      img: promise3,
      title: "Unlimited Aftercare",
      description:
        "We provide follow-up appointments and on gouging support for as long as you red",
    },
    {
      img: promise4,
      title: "Your Choice of Consultant",
      description:
        "You can choose a specialist that best suits your requirement and change if you wish.",
    },
    {
      img: promise5,
      title: "Guaranteed Consultation",
      description:
        "Once you have scheduled your treatment, we guarantee it will not be cancelled.",
    },
    {
      img: promise6,
      title: "No Waiting Lists",
      description:
        "Receive prompt access to diagnosis and treatment without the need to wait",
    },
  ];
  return (
    <section>
      <div className=" flex flex-col justify-center  items-center gap-4 mt-8 ">
        ...
        <h3 className=" font-manrope font-bold text-[28px] text-gradient-btn text-center">
          {ourPromiseData?.sub_heading}{" "}
        </h3>
