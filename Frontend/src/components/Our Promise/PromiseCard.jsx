...
const PromiseCard = () => {
  return (
    // main container
    <div className=" flex flex-col justify-center items-center font-general-sans bg-Primary-Blue-50 p-6 gap-2 rounded-lg shadow-lg max-w-[317px]  2xl:max-w-[350px]">
